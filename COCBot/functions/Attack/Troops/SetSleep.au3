...
Func SetSleep($type)
	...
	; If switching to Multi-finger mode from Save Troops for collectors mode, return 0 for a fast deploy
	If $iMatchMode = $DB And $iChkDeploySettings[$iMatchMode] = $eSmartSave And $usingMultiFinger = True Then Return 0
    Local $factor0 = 10
	Local $factor1 = 100
