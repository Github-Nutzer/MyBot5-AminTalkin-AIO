...
Global $iOldsmartZapGain = 0, $iOldNumLTSpellsUsed = 0 ; Used to Update Smart Zap Totals - Added by LunaEclipse
...
Func UpdateStats()
	...
	; Added by LunaEclipse for SmartZap
...
Func ResetStats()
	...
	$smartZapGain = 0 ; Added by LunaEclipse for SmartZap
	$numLSpellsUsed = 0 ; Added by LunaEclipse for SmartZap
	For $i = 0 To $iModeCount
