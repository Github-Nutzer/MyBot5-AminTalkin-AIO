...
Func btnStart()
	...
	If $RunState = False Then
		...
		For $i = $FirstControlToHide To $LastControlToHide ; Save state of all controls on tabs
			...
			If $i = $tabGeneral Or $i = $tabSearch Or $i = $tabAttack Or $i = $tabAttackAdv Or $i = $tabDonate Or $i = $tabTroops Or $i = $tabMisc Or $i = $tabNotify Or $i = $tabUpgrades Or $i = $tabEndBattle Or $i = $tabExpert Or $i= $tabAttackCSV Or $i = $tabDeploy Or $i = $tabMOD Or $i = $tabProfiles Or $i = $tabDeploy Or $i = $tabDonateStats Then ContinueLoop ; exclude tabs
		...
		For $i = $FirstControlToHide To $LastControlToHide ; Disable all controls in 1 go on all tabs
			; Added $tabAndroid to the list - Added by LunaEclipse
			If $i = $tabGeneral Or $i = $tabSearch Or $i = $tabAttack Or $i = $tabAttackAdv Or $i = $tabDonate Or $i = $tabTroops Or $i = $tabMisc Or $i = $tabNotify Or $i = $tabUpgrades Or $i = $tabEndBattle Or $i = $tabExpert Or $i=$tabAttackCSV Or $i = $tabDeploy Or $i = $tabMOD Or $i = $tabProfiles Or $i = $tabDonateStats Then ContinueLoop ; exclude tabs
			If $pEnabled And $i = $btnDeletePBmessages Then ContinueLoop ; exclude the DeleteAllMesages button when PushBullet is enabled
			If $i = $btnMakeScreenshot Then ContinueLoop ; exclude
			If $i = $divider Then ContinueLoop ; exclude divider
...
Func btnStop()
	...
	If $RunState Then ; Or BitOr(GUICtrlGetState($btnStop), $GUI_SHOW) Then ; $btnStop check added for strange $RunState inconsistencies
		...
		For $i = $FirstControlToHide To $LastControlToHide ; Restore previous state of controls
			; Added $tabAndroid to the list - Added by LunaEclipse
			If $i = $tabGeneral Or $i = $tabSearch Or $i = $tabAttack Or $i = $tabAttackAdv Or $i = $tabDonate Or $i = $tabTroops Or $i = $tabMisc Or $i = $tabNotify Or $i = $tabEndBattle Or $i = $tabExpert Or $i = $tabDeploy Or $i = $tabMOD Or $i = $tabProfiles Or $i = $tabDonateStats Then ContinueLoop ; exclude tabs
			If $pEnabled And $i = $btnDeletePBmessages Then ContinueLoop ; exclude the DeleteAllMesages button when PushBullet is enabled
			If $i = $btnMakeScreenshot Then ContinueLoop ; exclude
			If $i = $divider Then ContinueLoop ; exclude divider
